const tourPackages = [
    { id: 1, name: "Eksotisme Raja Ampat", location: "Raja Ampat", type: "Open Trip", price: 5500000, image: "/search/img/rajaampat.jpg", rating: 5 },
    { id: 2, name: "Festival Lembah Baliem", location: "Wamena", type: "Private", price: 8500000, image: "/search/img/wamena.jpeg", rating: 5 },
    { id: 3, name: "Berenang dengan Hiu Paus", location: "Nabire", type: "Open Trip", price: 4200000, image: "/search/img/nabire.jpg", rating: 4 },
    { id: 4, name: "Raja Ampat Premium Dive", location: "Raja Ampat", type: "Private", price: 12000000, image: "/search/img/dive.jpg", rating: 5 }
];
...
function renderPackages(data) {
    ...
    data.forEach(pkg => {
        ...
        const detailLink = `../detail/detail.html?id=${pkg.id}`;
