-- =============================================
-- CARA IMPORT YANG BENAR - BACA INI!
-- =============================================
-- 
-- LANGKAH 1: Buka phpMyAdmin
-- LANGKAH 2: Klik tab "SQL" di BAGIAN ATAS (jangan pilih database dulu!)
-- LANGKAH 3: Copy-paste SEMUA script ini (dari baris 1 sampai akhir)
-- LANGKAH 4: Klik "Go"
-- LANGKAH 5: Refresh phpMyAdmin (F5)
-- LANGKAH 6: Seharusnya hanya ada 1 database: explore_papua
--
-- =============================================
...
('INV-2024001', 2, 1, '2025-01-15', 2, 11000000.00, 'paid'),
('INV-2024002', 3, 3, '2025-01-20', 1, 4200000.00, 'paid'),
('INV-2024003', 2, 5, '2025-02-01', 3, 7500000.00, 'confirmed'),
('INV-2024004', 4, 2, '2025-02-10', 2, 17000000.00, 'pending'),
('INV-2024005', 3, 4, '2025-02-15', 1, 12000000.00, 'paid'),
('INV-2024006', 2, 8, '2025-03-01', 4, 15200000.00, 'cancelled');
...
-- =============================================
-- Harusnya muncul:
-- - Database: explore_papua
-- - Tables: users (4 rows), tours (8 rows), orders (6 rows)
-- - Views: view_orders_detail
-- - TIDAK ADA: explore_papua_db, tour_packages
--
-- Login Testing:
