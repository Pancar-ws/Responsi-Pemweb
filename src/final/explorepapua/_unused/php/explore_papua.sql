...
-- Untuk proyek Explore Papua Tourism Website
-- =============================================

-- PENTING: Jalankan script ini di database KOSONG atau baru!
-- Jika database sudah ada, hapus manual dulu dari phpMyAdmin

-- Buat database baru (comment jika database sudah ada)
CREATE DATABASE IF NOT EXISTS explore_papua;
...
('Ekspedisi Gunung Carstensz', 'Mimika', 'Customized', 15000000.00, 'carstensz.jpg',
